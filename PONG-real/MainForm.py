...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._leftscore.Location = System.Drawing.Point(83, 96)
		...
		self._lblball.ForeColor = System.Drawing.Color.Coral
		...
		self._lblleft.ForeColor = System.Drawing.Color.Coral
		...
		self._lblright.ForeColor = System.Drawing.Color.Coral
	...
	def MainFormSizeChanged(self, sender, e):
		...
		self._lblballClick.Top = self.Height // 2
	...
	def MainFormKeyDown(self, sender, e):
		...
		def reset():
			...
			# TODO reset secrets EX: christmas colors
		...
		if e.KeyCode == Keys.M:
			reset()
			self._lbltitle.Visible = True
			self._lbltitle.Text = "Use W and S to move the paddle; hit enter to begin"
		...
		if tdum.Enabled:
			if e.KeyCode == Keys.Up:
				...
				tright.Enabled = False
		# TODO fisnish multiplayer controls
